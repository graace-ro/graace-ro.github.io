...
for group_value in ['No','Yes']: #for the answers of no and yes
    ...
    for col in numeric_cols: #for the numeric columns
        ...
        df.loc[group.index[outlier_mask], 'Numeric_Outlier'] = True #the indeces of these values, for that group, is set to true
print(df.columns)
...
for group_value in ['No','Yes']:
    ...
    for col in categorical_cols:
        ...
        df.loc[group.index[group_mask], 'Categorical_Outlier']=True #set those rows to true
